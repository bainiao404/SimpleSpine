 ...
 * @public
 */
export declare type IntArrayLike = Array<number> | Int16Array;
...
export declare class TextureAtlas implements Disposable {
    ...
    constructor(atlasText?: string, textureLoader?: (path: string, loaderFunction: (tex: BaseTexture | SpineTexture) => any) => any, callback?: (obj: TextureAtlas) => any);
    ...
    addSpineAtlas(atlasText: string, textureLoader: (path: string, loaderFunction: (tex: BaseTexture | SpineTexture) => any) => any, callback: (obj: TextureAtlas) => any): void;
    private load;
...
export declare class TextureAtlasPage {
    ...
    uWrap: TextureWrap;
    vWrap: TextureWrap;
    baseTexture: BaseTexture | SpineTexture;
    width: number;
    height: number;
    pma: boolean;
    setFilters(): void;
